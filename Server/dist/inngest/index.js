...
// User sync functions
async function syncUserCreation(data) {
    try {
...
async function syncUserDeletion(data) {
    try {
...
async function syncUserUpdation(data) {
    try {
...
async function syncWorkspaceCreation(data) {
    try {
...
async function syncWorkspaceUpdation(data) {
    try {
...
async function syncWorkspaceDeletion(data) {
    try {
...
async function syncWorkspaceMemberCreation(data) {
    try {
        await prisma.workspaceMember.create({
            data: {
                userId: data.user_id,
...
const syncWorkspaceMemberCreationFn = inngest.createFunction({ id: 'sync-workspace-member-from-clerk' }, { event: 'clerk/organisationInvitation' }, async ({ event }) => await syncWorkspaceMemberCreation(event.data));
